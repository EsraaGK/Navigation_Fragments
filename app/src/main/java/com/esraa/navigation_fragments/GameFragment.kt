...
import com.esraa.navigation_fragments.databinding.FragmentGameBinding
                ...
                if (answers[answerIndex] == currentQuestion.answers[0]) {
                    ...
                    if (questionIndex < numQuestions) {
                      ...
                      //  view.findNavController().navigate(R.id.action_gameFragment_to_gameWonFragment)
                        //or Using directions to navigate to the GameOverFragment   // Adding the parameters to the Action
